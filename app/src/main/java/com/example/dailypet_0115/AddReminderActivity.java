...
import com.example.dailypet_0115.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mDate = mDay + "/" + mMonth + "/" + mYear;//原本
        if (mMinute < 10 && mHour == 0) {
        ...
        mRepeatText.setText("每 " + mRepeatNo + " " + mRepeatType + "重複一次");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                // which is the {@link com.example.dailypet_0115.MainActivity}.
...
*/
        ...
        mCalendar.set(Calendar.MONTH, --mMonth);//改
        ...
        // Check repeat type
        if (mRepeatType.equals("分鐘")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milMinute;
        } else if (mRepeatType.equals("小時")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milHour;
        } else if (mRepeatType.equals("天")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milDay;
        } else if (mRepeatType.equals("週")) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("每 " + repeatNo + " " + repeatType + "重複一次");
            // Setup up active buttons
            // Setup repeat switch

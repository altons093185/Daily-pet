    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mapintent=new Intent(MapsActivity.this,com.example.dailypet_0115.MainActivity.class);
...
//        mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
        ...
        ImageView btncare = findViewById(R.id.B_veterinaryhospital);
        btncare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MapsActivity.this,"附近的寵物醫院...", Toast.LENGTH_LONG).show();
            }
        });

        ImageView btnstore = findViewById(R.id.B_petsalon);
        btnstore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlaces getNearbyPlacesData = new GetNearbyPlaces();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"附近的寵物店...", Toast.LENGTH_LONG).show();
            }
        });
    }
